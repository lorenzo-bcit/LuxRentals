...
namespace LuxRentals.Migrations
{
    ...
    public partial class InitialIdentitySetup : Migration
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__BookingS__9B31AD42926FE053", x => x.pkBookingStatusId);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__CarStatu__18420CBDF71FC4AD", x => x.pkCarStatusId);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__Customer__1FD9D5A21845FCB4", x => x.pkCustomerId);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__FuelType__8BECB883228BC67B", x => x.pkFuelTypeId);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__Make__DCFC4DDA58E2E141", x => x.pkMakeId);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__VehicleC__0B88CBFEE83AAA95", x => x.pkVehicleClassId);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__Model__C59EF50784A88CAE", x => x.pkModelId);
                table.ForeignKey(
                    name: "FK_Model_Make",
                    column: x => x.fkMakeId,
                    principalTable: "Make",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__Car__042F2AAC8C207229", x => x.pkCarId);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__Booking__8A399DE04656770F", x => x.pkBookingId);
                table.ForeignKey(
                    name: "FK_Booking_Car",
                    column: x => x.fkCarId,
                    principalTable: "Car",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__Transact__D3354406B02BEB62", x => x.pkTransactionId);
                table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Car__1771C83D32098E36",
                table: "Car",
                column: "licencePlate",
                unique: true);
        
            migrationBuilder.CreateIndex(
                name: "UQ__Car__96F3ADF4CF09D564",
                table: "Car",
                column: "vinNumber",
                unique: true);
        
            migrationBuilder.CreateIndex(
                name: "UQ__Customer__021FFF57F2588E48",
                table: "Customer",
                column: "driverLicenceNo",
                unique: true);
        
            migrationBuilder.CreateIndex(
                name: "UQ__Customer__AB6E6164D14DE559",
                table: "Customer",
                column: "email",
                unique: true);
