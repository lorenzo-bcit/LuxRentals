...
public class LuxRentalExperimentalContext : IdentityDbContext
{
    ...
    public LuxRentalExperimentalContext(DbContextOptions<LuxRentalExperimentalContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PkBookingStatusId).HasName("PK__BookingS__9B31AD42926FE053");
        ...
        {
            entity.HasKey(e => e.PkCarId).HasName("PK__Car__042F2AAC8C207229");

            entity.ToTable("Car");

            entity.HasIndex(e => e.LicencePlate, "UQ__Car__1771C83D32098E36").IsUnique();

            entity.HasIndex(e => e.VinNumber, "UQ__Car__96F3ADF4CF09D564").IsUnique();
        ...
        {
            entity.HasKey(e => e.PkCarStatusId).HasName("PK__CarStatu__18420CBDF71FC4AD");
        ...
        {
            entity.HasKey(e => e.PkCustomerId).HasName("PK__Customer__1FD9D5A21845FCB4");

            entity.ToTable("Customer");

            entity.HasIndex(e => e.DriverLicenceNo, "UQ__Customer__021FFF57F2588E48").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Customer__AB6E6164D14DE559").IsUnique();
        ...
        {
            entity.HasKey(e => e.PkFuelTypeId).HasName("PK__FuelType__8BECB883228BC67B");
        ...
        {
            entity.HasKey(e => e.PkMakeId).HasName("PK__Make__DCFC4DDA58E2E141");
        ...
        {
            entity.HasKey(e => e.PkModelId).HasName("PK__Model__C59EF50784A88CAE");
        ...
        {
            entity.HasKey(e => e.PkTransactionId).HasName("PK__Transact__D3354406B02BEB62");
        ...
        {
            entity.HasKey(e => e.PkVehicleClassId).HasName("PK__VehicleC__0B88CBFEE83AAA95");
